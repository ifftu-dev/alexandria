...
The next T03 slice moves the talent-index Bloom level reader onto the verified
scoring inputs that derived skill states, reputation rows and snapshot evidence
now share. The preprod profile pins no
