      ...
      <div ref="userMenuRef" class="user-menu relative">
        ...
        >
          <div v-if="userMenuOpen" class="absolute right-0 mt-2 w-56 origin-top-right rounded-xl border border-border bg-card shadow-lg z-50">
            ...
            <div class="p-1">
              <!-- My Profile -->
              <button class="flex items-center gap-2 rounded-lg px-3 py-2 w-full text-sm text-foreground transition-colors hover:bg-muted" @click="navigateFromMenu('/profile')">
              ...
              <!-- Settings -->
              <button class="flex items-center gap-2 rounded-lg px-3 py-2 w-full text-sm text-foreground transition-colors hover:bg-muted" @click="userMenuOpen = false; openSettings()">
                <svg class="h-4 w-4 text-muted-foreground" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
