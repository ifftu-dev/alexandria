...
| Database | `db/` | SQLite + 90 versioned migrations (one DB per profile). Retired challenge/plugin-attestation tables remain legacy storage until D03 and grant no authority. |
...
| `db/schema.rs` | 3573 | 90 migrations |
